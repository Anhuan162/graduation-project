...
public class TopicPermissions {
  ...
  public static final Set<String> BASIC_RIGHTS =
      Set.of("CREATE_POST", "CREATE_COMMENT", "CREATE_REACTION", "CREATE_REPORT");

  public static final Set<String> PRIVATE_RIGHTS =
      Set.of(
          "DELETE_OWN_TOPIC",
          "DELETE_OWN_POST",
          "DELETE_OWN_COMMENT",
  ...
  public static final Set<String> MODERATOR_RIGHTS =
      Set.of(
          "DELETE_ANY_POST",
          "DELETE_ANY_COMMENT",
          "APPROVE_MEMBER",
