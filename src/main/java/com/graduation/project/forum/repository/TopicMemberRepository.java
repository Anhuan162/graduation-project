...
public interface TopicMemberRepository extends JpaRepository<TopicMember, UUID> {
    Page<TopicMember> findByTopicId(UUID topicId, Pageable pageable);

    Page<TopicMember> findByTopicIdAndApproved(UUID topicId, boolean approved, Pageable pageable);
