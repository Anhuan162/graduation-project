...
VALUES ('417c9992-8bd1-41f2-852e-54b3e7ca7667', NULL, 'huanmanutd2k3@gmail.com', 1,
        NULL, '$2a$10$vSOxFQ8Qr2i7421Q8C3rvu0HkY0fQQ/tT0xM2WtJ/2V4/YECL9GRO', NULL, 'LOCAL', NULL);
INSERT INTO authdb.users
(id, avatar_url, email, enabled, full_name, password, phone, provider, student_code)
VALUES ('4af76b85-6971-47b1-a4aa-0f83da58f2f5', NULL, 'huan1622k3@gmail.com', 1,
        NULL, '$2a$10$eezkDqG.gNQKxeEXHJrqquDhVmJVTsMc5GFxkCOpEdrqDm1.NOayG', NULL, 'LOCAL', NULL);
INSERT INTO authdb.users
(id, avatar_url, email, enabled, full_name, password, phone, provider, student_code)
VALUES ('c264acd5-a212-4f97-9a85-e68da8b48e38', NULL, 'huan162182143@gmail.com', 1,
        NULL, '$2a$10$WeX1Zf55Vb5j7qiaV5YA4OZn8efuABvdcuKrWKvC.5qYf0LvzURtW', NULL, 'LOCAL', NULL);


INSERT INTO authdb.roles
    (name, description)
VALUES ('ADMIN', NULL);
INSERT INTO authdb.roles
    (name, description)
...
INSERT INTO authdb.permissions
...
INSERT INTO authdb.roles_permissions
...
INSERT INTO authdb.invalidated_token
...
INSERT INTO authdb.announcements
...
INSERT INTO authdb.notification_events
...
INSERT INTO authdb.user_notifications
(id, delivered_at, is_read, notification_status, read_at, notification_event_id, user_id)
VALUES('ff4ed179-99a5-4212-bf1a-b150e352ce7b', NULL, 0, 'SENT', NULL, 'e7127daf-583d-4d83-9cc0-ab567cd622a7', 'c264acd5-a212-4f97-9a85-e68da8b48e38');